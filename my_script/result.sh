...
# modified version
python3 ../eval_cqd.py --cuda --checkpoint_path ../checkpoints_FB15K-237/modified_version/cqdlite_attr_kblrn_1st/ --data_path ../data/FB15k-237-q2b --rank 1000 --test_batch_size 1024 --print_on_screen --train_times 100 --geo cqd-complexa
python3 ../eval_cqd.py --cuda --checkpoint_path ../checkpoints_FB15K-237/modified_version/cqdlite_attr_kblrn_2nd/ --data_path ../data/FB15k-237-q2b --rank 1000 --test_batch_size 1024 --print_on_screen --train_times 100 --geo cqd-complexa --to_latex
...
#modified version
python3 ../eval_cqd.py --do_test --checkpoint_path ../checkpoints_FB15K-237/modified_version/cqdlite_attr_kblrn_1st/ --data_path ../data/scripts/generated/FB15K-237_dummy_kblrn --use_attributes --rank 1000 --geo cqd-complexa --test_batch_size 1024 --print_on_screen
python3 ../eval_cqd.py --do_test --checkpoint_path ../checkpoints_FB15K-237/modified_version/cqdlite_attr_kblrn_2nd/ --data_path ../data/scripts/generated/FB15K-237_dummy_kblrn --use_attributes --rank 1000 --geo cqd-complexa --test_batch_size 1024 --print_on_screen
